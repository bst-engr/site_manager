        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="#" onclick="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Portal Subscribers</a>
                <ul class="dropdown-menu portal_menu">
                  <li><a href="#">Netpatibles.com</a></li>
                  <li><a href="#">shi-cat.com</a></li>
                  <li><a href="#">ats.blixx.net</a></li>
                  <li><a href="#">Netpatibles.com</a></li>
                  <li><a href="#">shi-cat.com</a></li>
                  <li><a href="#">ats.blixx.net</a></li>
                  <li><a href="#">Netpatibles.com</a></li>
